...
app.on('request', function (request, response) {
    ...
    case '/'://カレントディレクトリは/で読んでしまう　故にディレクトリを分けて管理する必要がある。
        ...
        break;
    case '/css/bootstrap.min.css'://こいつらが見つかってない
        console.log("2");
        ...
        break;
    case '/css/bootstrap.css'://こいつらが見つかってない
        console.log("3");
   ...
   case '/css/iziToast.css':
	...
	case '/img/favicon.ico':
		console.log("アイコンを認識しました。")
        fs.readFile('./img/favicon.ico', 'UTF-8',
            function (err, data) {
        ...
        break;
	case '/img/favicon2.ico':
	console.log("アイコンを認識しました。")
    fs.readFile('./img/favicon2.ico', 'UTF-8',
            function (err, data) {
                response.writeHead(200, {'Content-Type': 'image/x-icon'});
                response.write(data);
                response.end();
